    ...
    Limbs<V, P::Limbs>: Copy,
{
        ...
        V: Into<AB::Expr>,
    {
        ...
        // SXIAUM PATCH (rustc >= 1.89 inference, rust-lang/rust#137268):
        // explicit target types for `Into` conversions; semantics unchanged.
...
mod tests {
        ...
        Limbs<AB::Var, P::Limbs>: Copy,
    {
        fn eval(&self, builder: &mut AB) {
            ...
            local
                .a_den_b
                .eval(builder, &local.a, &local.b, self.sign, AB::F::zero());
        }
    }
